...
const PersonalisedTrainingSignUpScreen = () => {
  ...
  const handlePress = async () => {
    ...
    setErrorMessage('');
   router.push(`/questionnaire?Id=${response.data.createUser.name}`);
  };
            ...
            {errorMessage ? (
              ...
              <Text style={styles.label}>First Name:</Text>
                ...
                <Text style={styles.text1}>
                   By continuing with questionnaire and creating this account I agree with <Link href="/start-screen" style={styles.red_link}>Terms</Link> and <Link href="/start-screen" style={styles.red_link}>Global Privacy Statement</Link>.
                </Text>
...
export default PersonalisedTrainingSignUpScreen;
