...
import ExerciseComponent2 from '@/components/ExerciseComponent2';
...
const Exercises2Screen = () => {

  const router = useRouter(); 

  const navigation = useNavigation(); 

  const { selectedExercises2, clearExercises} = useExerciseContext();
  ...
  console.log(exercisesData[1].Video);
  ...
  const renderItem = React.useCallback(({ item }:{ item: any }) => {
    return <ExerciseComponent2 exercise={item} />;
...
export default Exercises2Screen;
